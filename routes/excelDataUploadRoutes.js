...
// // // // Configure multer for file uploads (similar to your existing setup)
...
// // //     cb(null, 'excel-data-' + uniqueSuffix + '-' + file.originalname);
// // //   }
// // // });
...
// // // // Routes - Using similar pattern as your existing code
// // // router.get('/available-tables', excelDataController.getAvailableTables);
// // // router.post('/upload-excel-data', upload.single('excelFile'), excelDataController.processExcelData);
