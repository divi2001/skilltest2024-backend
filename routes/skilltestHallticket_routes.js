...
// ✅ CHANGED: GET → POST to accept body with customization
router.post('/download-skilltest-hall-ticket/:applicationNo', skilltestHallticketController.downloadSkillTestHallTicket);

// ✅ CHANGED: GET → POST to accept body with customization
router.post('/download-all-skilltest-hall-tickets', skilltestHallticketController.downloadAllSkillTestHallTickets);

// Test route to check department logo
router.get('/test-department-logo/:departmentId', skilltestHallticketController.getDepartmentLogo2);
