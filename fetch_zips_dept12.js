// Download zip files for Department 12, Batches 201/202
...
const DOWNLOAD_DIR = path.join(__dirname, 'downloaded_zips_dept12');

const DEPARTMENT_ID = 12;
const BATCHES = [201, 202];
...
const main = async () => {
    try {
        ...
        if (rows.length === 0) {
            console.log('\n⚠️  No trackrecord entries found for dept 12, batches 201/202.');
