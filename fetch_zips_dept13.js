// Download zip files for Department 13 (today's date only)
...
const DOWNLOAD_DIR = path.join(__dirname, 'downloaded_zips_dept13');

const DEPARTMENT_ID = 13;
...
const main = async () => {
    try {
        ...
        if (rows.length === 0) {
            console.log('\n⚠️  No trackrecord entries found for dept 13 with today\'s date.');
