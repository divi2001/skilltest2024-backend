...
/**
 * Create timestamped folder for storing hall tickets
 */
function createHallTicketFolder(departmentId) {
  ...
  // Create specific folder for this batch
...
/**
 * Clean up old hall ticket folders (older than 24 hours)
 */
...
// Generate and save all hall tickets to folder
exports.downloadAllSkillTestHallTickets = async (req, res) => {
  let browser = null;
...
// Test endpoint to fetch department logo
exports.getDepartmentLogo2 = async (req, res) => {
  try {
    const { departmentId } = req.params;
