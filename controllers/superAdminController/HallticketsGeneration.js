...
//     // Map database fields to GCC TBC format
//     const studentData = {
...
//       password: dbStudent.password?.toString() || 'N/A',
...
//     console.log('✓ Student data mapped:', studentData.seatNo);
...
//       },
//       info: {
//         Title: `Hall Ticket for ${studentData.seatNo}`,
//         Author: 'Examination System',
//         Producer: 'PDFKit with UTF-8 support'
//       },
//       autoFirstPage: false
...
//     console.log('✅ GCC TBC PDF generated successfully');

//   } catch (error) {
//     console.error('❌ GCC TBC PDF generation error:', error);
//     throw error;
//   }
// }
...
//   try {
//     console.log('🎨 Generating bulk GCC TBC PDFs from database...');
...
//   } catch (error) {
//     console.error('❌ Bulk GCC TBC PDF generation error:', error);
//     throw error;
//   }
// }
...
//   downloadAllHallTickets,
//   downloadHallTicketForStudent,
//   generateGccTbcHallTicketFromDB,        // ✅ NEW EXPORT
//   generateGccTbcBulkHallTicketsFromDB    // ✅ NEW EXPORT
// };
